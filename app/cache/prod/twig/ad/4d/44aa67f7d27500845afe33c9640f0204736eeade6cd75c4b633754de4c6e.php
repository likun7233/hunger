...
class __TwigTemplate_ad4d44aa67f7d27500845afe33c9640f0204736eeade6cd75c4b633754de4c6e extends Twig_Template
{
      ...
      ";
        ...
        <td>
          ";
            // line 39
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (($this->getAttribute($_app_, "code") == "vip")) {
                // line 40
                echo "            <a href=\"../vip/list\" class=\"btn btn-primary\">管理</a>
          ";
            } elseif (($this->getAttribute($_app_, "code") == "coupon")) {
                // line 42
                echo "            <a href=\"../coupon\" class=\"btn btn-primary\">管理</a>
          ";
            } elseif (($this->getAttribute($_app_, "code") == "QuestionPlus")) {
                // line 44
                echo "            <a href=\"../question/plumber/setting\" class=\"btn btn-primary\">管理</a>
          ";
            } elseif (($this->getAttribute($_app_, "code") != "MAIN")) {
                // line 46
                echo "            <a href=\"../";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
          ...
          ";
            // line 49
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if (($this->env->getExtension('topxia_web_twig')->getSetting("developer.debug") && ($this->getAttribute($_app_, "code") != "MAIN"))) {
                // line 50
