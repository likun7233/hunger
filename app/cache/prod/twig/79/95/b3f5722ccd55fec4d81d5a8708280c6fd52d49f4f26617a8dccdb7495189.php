...
class __TwigTemplate_7995b3f5722ccd55fec4d81d5a8708280c6fd52d49f4f26617a8dccdb7495189 extends Twig_Template
{
      ...
      ";
          ...
          <td>
            <a href=\"#\" data-toggle=\"modal\" data-target=\"#modal\" data-url=\"";
                    // line 42
                    if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_app_package_update_modal", array("id" => $this->getAttribute($this->getAttribute($_app_, "package"), "id"))), "html", null, true);
