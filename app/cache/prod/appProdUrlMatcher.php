...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '/test') {
            ...
            return array (  '_controller' => 'TopxiaWebBundle:Test:index',  '_route' => 'test',);
        }
            ...
            if (0 === strpos($pathinfo, '/admin/setting')) {
                ...
                if (0 === strpos($pathinfo, '/admin/setting/cloud')) {
                    ...
                    if ($pathinfo === '/admin/setting/cloud') {
                        return array (  '_controller' => 'Topxia\\AdminBundle\\Controller\\CloudSettingController::indexAction',  '_route' => 'admin_setting_cloud',);
                    }
